...
export type DeckProgressEnvelope = { version: 2; deckId: string; createdAt: number; updatedAt: number; modes: Record<string, StudyModeState>; deletedReviewIds?: string[]; pendingDeletedReviewIds?: string[] };
