...
export type ReviewRecord = { id: string; reviewedAt: number; result: ReviewResult; difficulty: ReviewDifficulty; responseTimeMs: number; intervalMs: number; strength: number; sessionId?: string; sessionStartedAt?: number };
...
export type ReviewTransaction = { reviewId: string; cardId: string; result: ReviewResult; difficulty: ReviewDifficulty; responseTimeMs: number; beforeState: StudyModeState; sessionId?: string; sessionStartedAt?: number };
