...
export type ReviewRecord = { id: string; reviewedAt: number; result: ReviewResult; difficulty: ReviewDifficulty; responseTimeMs: number; intervalMs: number; strength: number; sessionId?: string; sessionStartedAt?: number; sessionName?: string; activityKind?: StudyActivityKind };
